  ...
  return (
    ...
    >
      ...
      >
        <Modal>
          <ModalOpenButton>
            <Button onClick={() => console.log('opening the modal')} variant="primary">Login</Button>
          </ModalOpenButton>
          <ModalContents aria-label="Login" modalTitle="Login">
        ...
        <Modal>
          <ModalOpenButton>
            <Button variant="secundary">Register</Button>
          </ModalOpenButton>
          <ModalContents aria-label="Register" modalTitle="Register">
